...
const AddToys = () => {
  ...
  return (
    <div className="bg-neutral-200 py-4 md:py-6">
      <form onSubmit={handleAddToysForm} className='flex flex-col gap-4'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-x-10 md:gap-y-8'>
          ...
          <div>
            ...
            <TextInput id='quantity' type='text' name='quantity' required={true} />
          </div>
          {/* car category */}
          <div>
            <div className='mb-2 '>
            ...
            <TextInput id='category' type='text' name='category' required={true}
            />
          </div>
            {/* car price */}
          <div>
          ...
          <div>
            ...
            <TextInput id='description' type='text' name='description' required={true}
            />
          </div>
        </div>
